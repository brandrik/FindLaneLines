...
def draw_lines(img: np.ndarray, lines: Sequence[StraightLine], color=[255, 0, 0], thickness=10):
    """
...
def hough_lines(img, rho, theta, threshold, min_line_len, max_line_gap) -> Sequence[StraightLine]:
    """
